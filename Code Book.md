The run_analysis.R script that we have produced performs the data preparation and then is followed by the five steps as  described in the course project’s definition.
